...
int main(int argc, char** argv) {
    ...
    Pose::PoseEstimator pose_estimator(nh, "/aruco_detector/aruco_detected", "/color_detector/color_detected", 
                                            "/rosout", "/camera/camera_info", "/pose_estimator/aruco_pose", 17);
    while (ros::ok()) {
        ros::spinOnce();
